...
void setup(void) {
  ...
  // while (!Serial);
  delay(2000);
  Serial.println("All seeing and speaking skull");
...
//  musicPlayer.sineTest(0x44, 500);    // Make a tone to indicate VS1053 is working
  ...
  Serial.println(F("About to start playing file"));
  musicPlayer.playFullFile("VOICES~1/GO-HELOW.MP3");


  // End Music player setup

  // Accelerometer, pixels, and cap touch setup
  ...
  // End Accelerometer, pixels, and cap touch setup
      ...
      if(!musicPlayer.playingMusic) {
        switch(millis()%3) {
          case 0:
            ...
            musicPlayer.startPlayingFile("VOICES~1/GO-HELOW.MP3");
            break;
          case 1:
            Serial.println("Case 1");
            musicPlayer.startPlayingFile("VOICES~1/GO-ICU.MP3");
            break;
          case 2:
            Serial.println("Case 2");
            musicPlayer.startPlayingFile("VOICES~1/GO-HELOF.MP3");
            break;
        }
      }
    }
...
// From full_test used for the pixel cycle, I think
uint8_t j = 0;
...
void loop() {
  ...
  if (click & 0x30) {
    ...
    if(!musicPlayer.playingMusic) {
      musicPlayer.startPlayingFile("VOICES~1/THRILLER.MP3");
    }
  }
